...
export const NotificationsProvider = ({ children }) => {
  const [notifications, setNotifications] = useState([
    ...
    },
    {
      ...
      message: 'AC Repair - Block A requires immediate attention',
      type: 'maintenance',
    ...
    },
    {
      ...
      message: 'Monthly maintenance fee paid for unit A-101',
      type: 'payment',
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      const randomNotifications = [
        ...
        { title: 'Maintenance Update', message: 'Scheduled maintenance completed', type: 'maintenance' },
