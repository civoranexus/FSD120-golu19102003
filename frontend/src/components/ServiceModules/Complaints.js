            ...
            <div className="p-6">
              ...
              <div className="flex justify-between items-center">
                ...
                <button 
                  ...
                  className="bg-[#EF4444] hover:bg-[#EB1414] text-white px-3 py-1 rounded text-sm"
                >
                  View Details
                </button>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto border-2" style={{boxShadow: '0 20px 25px -5px rgba(20, 119, 131, 0.1), 0 10px 10px -5px rgba(20, 119, 131, 0.04)', borderColor: '#1B9AAA'}}>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <div className={`p-3 rounded-full ${getStatusColor(selectedComplaint.status)}`}>
                    {React.createElement(getCategoryIcon(selectedComplaint.category), { className: "h-6 w-6" })}
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-gray-900">{selectedComplaint.title}</h3>
                    <span className={`ml-2 px-3 py-1 rounded-full text-sm font-medium ${getPriorityColor(selectedComplaint.priority)}`}>
              ...
              <div>
                ...
                <p className="text-gray-600 bg-gray-50 p-4 rounded-lg">{selectedComplaint.description}</p>
              </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">{selectedComplaint.resident}</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">{selectedComplaint.unit}</p>
                    </div>
                  </div>
                </div>
                <div className="space-y-3">
              ...
              <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                ...
                <button
                  className="px-6 py-2 bg-[#1B9AAA] text-white rounded-lg hover:bg-[#147783]"
                >
                  Update Status
                </button>
              </div>
