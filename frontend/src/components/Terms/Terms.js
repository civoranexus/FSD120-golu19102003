        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-3 text-gray-700">
              <p>By accessing and using Society360, you accept and agree to be bound by these terms and conditions.</p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-3 text-gray-700">
              ...
              <p>By using Society360, you consent to the collection and use of information as described in our Privacy Policy.</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-3 text-gray-700">
              <p>We strive to maintain high availability of Society360 services.</p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-3 text-gray-700">
              <p>Society360 is provided "as is" without warranties of any kind.</p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-3 text-gray-700">
              <p>We reserve the right to suspend or terminate your access to Society360 at any time, with or without cause.</p>
